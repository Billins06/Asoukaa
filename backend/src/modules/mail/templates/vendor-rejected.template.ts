export const vendorRejectedTemplate = (prenom: string, shopName: string, motif: string): string => `
<!DOCTYPE html>
<html lang="fr">
        ...
        <table width="600" cellpadding="0" cellspacing="0" style="background:#fff;border-radius:12px;overflow:hidden;box-shadow:0 2px 8px rgba(0,0,0,0.1);">
          ...
          <tr>
            <td style="padding:40px 32px;">
              <h2 style="color:#1a1a1a;margin:0 0 16px;">Demande vendeur non approuvée</h2>
              <p style="color:#555;font-size:15px;line-height:1.6;margin:0 0 24px;">
                Bonjour <strong>${prenom}</strong>,<br/>
                Après examen, votre demande pour la boutique <strong>"${shopName}"</strong> n'a pas pu être approuvée.
              </p>
              ...
              <p style="color:#555;font-size:14px;">
                Vous pouvez corriger les points mentionnés et soumettre à nouveau votre demande depuis l'application.
              </p>
            </td>
          </tr>
          <tr>
